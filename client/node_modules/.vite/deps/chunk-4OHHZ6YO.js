...
// node_modules/@designcodeio/threeui/lib-dist/shaders/neuform-isolated/NeuformBatchEffects.js
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var import_react = __toESM(require_react(), 1);

// node_modules/@designcodeio/threeui/lib-dist/shaders/neuform-isolated/sources/constellation-field.html.js
var n = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8" />
...
// node_modules/@designcodeio/threeui/lib-dist/shaders/neuform-isolated/sources/particle-drift.html.js
var n2 = `<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
// node_modules/@designcodeio/threeui/lib-dist/shaders/neuform-isolated/sources/particle-network.html.js
var n3 = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
// node_modules/@designcodeio/threeui/lib-dist/shaders/neuform-isolated/sources/flux-vortex.html.js
var n4 = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
// node_modules/@designcodeio/threeui/lib-dist/shaders/neuform-isolated/sources/portal-field.html.js
var e = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
// node_modules/@designcodeio/threeui/lib-dist/shaders/neuform-isolated/sources/flow-field.html.js
var n5 = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
// node_modules/@designcodeio/threeui/lib-dist/shaders/neuform-isolated/sources/amber-halftone.html.js
var n6 = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
// node_modules/@designcodeio/threeui/lib-dist/shaders/neuform-isolated/sources/diagnostics-panel.html.js
var t = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
// node_modules/@designcodeio/threeui/lib-dist/shaders/neuform-isolated/sources/signal-particles.html.js
var t2 = `<!doctype html>
...
// node_modules/@designcodeio/threeui/lib-dist/shaders/neuform-isolated/sources/skeuomorphic-toggle.html.js
var e2 = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
// node_modules/@designcodeio/threeui/lib-dist/shaders/neuform-isolated/sources/matrix-field.html.js
var n7 = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
// node_modules/@designcodeio/threeui/lib-dist/shaders/neuform-isolated/sources/gateway-flow.html.js
var e3 = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
// node_modules/@designcodeio/threeui/lib-dist/shaders/neuform-isolated/sources/connectivity-graph.html.js
var n8 = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
// node_modules/@designcodeio/threeui/lib-dist/shaders/neuform-isolated/sources/interface-lines.html.js
var n9 = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
// node_modules/@designcodeio/threeui/lib-dist/shaders/neuform-isolated/sources/wireframe-forms.html.js
var t3 = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
// node_modules/@designcodeio/threeui/lib-dist/shaders/neuform-isolated/sources/defense-lines.html.js
var n10 = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
// node_modules/@designcodeio/threeui/lib-dist/shaders/neuform-isolated/sources/override-grid.html.js
var n11 = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
// node_modules/@designcodeio/threeui/lib-dist/shaders/neuform-isolated/sources/topo-field.html.js
var n12 = `<!DOCTYPE html>
...
var d = "#eef1f6";
function m(e4, t4, r) {
  return Math.min(r, Math.max(t4, e4));
}
function s(e4, t4, r = 1) {
  return Math.max(r, Math.round(e4 * t4));
}
function he(e4) {
  return e4 === "cylinders" || e4 === "sphere" ? e4 : "cube";
}
function g(e4, t4 = 3) {
  const r = Number(e4).toFixed(t4);
  return r.includes(".") ? r : `${r}.0`;
}
function fe(e4, t4 = "dark") {
  return e4 == null ? t4 : e4 === "light" || e4 === 1 || e4 === "1" ? "light" : "dark";
}
function P() {
  if (typeof document > "u" || typeof window > "u") return "dark";
  const e4 = document.documentElement, t4 = e4.dataset.scheme ?? e4.dataset.theme;
  return t4 === "light" || t4 === "dark" ? t4 : window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light";
}
function we(e4) {
  const [t4, r] = (0, import_react.useState)(P);
  return (0, import_react.useEffect)(() => {
    if (!e4 || typeof document > "u" || typeof window > "u") return;
    const o = document.documentElement, i = window.matchMedia("(prefers-color-scheme: dark)"), a = () => r(P()), n13 = new MutationObserver(a);
    return n13.observe(o, { attributes: true, attributeFilter: ["data-scheme", "data-theme"] }), i.addEventListener("change", a), a(), () => {
      n13.disconnect(), i.removeEventListener("change", a);
    };
  }, [e4]), t4;
}
function z(e4, t4) {
...
`;
function C(e4, { mode: t4 }) {
  let r = e4.replaceAll(
    "time += 0.015;",
    "time += 0.015 * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||1);"
  );
  return t4 === "light" && (r = r.replaceAll("ctx.fillStyle = '#020804';", `ctx.fillStyle = '${d}';`).replaceAll("rgba(52,211,153,", "rgba(4,120,87,")), r;
}
var l = {
  constellationField: {
    ...
    source: n,
    supportsMode: true,
    background: (e4) => e4 === "light" ? d : "#070914",
    targets: [{ selector: "#constellationCanvas", role: "background" }],
    patch(e4, { size: t4, length: r, density: o, strokeWidth: i, mode: a }) {
      let n13 = e4.replace("const LINK = 160;", `const LINK = ${Math.round(160 * r)};`).replace(
        "const MAX_NODES = window.innerWidth < 768 ? 40 : 85;",
        `const MAX_NODES = window.innerWidth < 768 ? ${s(40, o, 8)} : ${s(85, o, 12)};`
      ).replace(
        "radius: Math.random() * 2.4 + 1.8",
        `radius: (Math.random() * 2.4 + 1.8) * ${t4}`
      ...
      return a === "light" && (n13 = n13.replace("ctx.strokeStyle = '#E6C879';", "ctx.strokeStyle = '#8B6914';").replace("ctx.fillStyle = '#E6C879';", "ctx.fillStyle = '#8B6914';")), n13;
    }
  },
  particleDrift: {
    ...
    source: n2,
    supportsMode: true,
    background: (e4) => e4 === "light" ? d : "#030509",
    targets: [{ selector: "#particle-canvas", role: "background" }],
    patch(e4, { size: t4, length: r, density: o, mode: i }) {
      const a = Math.round(120 * r), n13 = i === "light" ? 0.22 : 0.15;
      let u = e4.replace("Array.from({ length: 90 })", `Array.from({ length: ${s(90, o, 12)} })`).replace("Array.from({ length: 25 })", `Array.from({ length: ${s(25, o, 4)} })`).replace("length: Math.random() * 100 + 50,", `length: (Math.random() * 100 + 50) * ${r},`).replace("n.y += n.vy; // Slow drift", "n.y += n.vy * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||1); // Slow drift").replace("b.y -= b.speed;", "b.y -= b.speed * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||1);").replace("if(d < 120) {", `if(d < ${a}) {`).replace("0.15 * (1 - d/120)", `${n13} * (1 - d/${a})`).replace("ctx.lineWidth = 1.5;", `ctx.lineWidth = ${Number((1.5 * t4).toFixed(2))};`);
  ...
  particleNetwork: {
    ...
    source: n3,
    supportsMode: true,
    background: (e4) => e4 === "light" ? d : "#05070d",
    targets: [{ selector: "#particle-canvas", role: "background" }],
    patch(e4, { size: t4, length: r, density: o, mode: i }) {
      let a = e4.replace("const particleCount = 200;", `const particleCount = ${s(200, o, 40)};`).replace("this.length = Math.random() * 2 + 0.5;", `this.length = (Math.random() * 2 + 0.5) * ${r};`).replace("this.z -= this.speed;", "this.z -= this.speed * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||1);").replace("const fov = 300;", `const fov = ${Math.round(300 / Math.max(0.4, t4))};`);
  ...
  fluxVortex: {
    ...
    patch(e4, { size: t4, density: r }) {
      return e4.replace("const vortexCount = 9500;", `const vortexCount = ${s(9500, r, 1200)};`).replace("const particlesCount = 300;", `const particlesCount = ${s(300, r, 40)};`).replace("size: 0.006, // Smaller dots requested", `size: ${Number((6e-3 * t4).toFixed(4))}, // Smaller dots requested`).replace("size: 0.008,", `size: ${Number((8e-3 * t4).toFixed(4))},`);
    }
  },
  portalField: {
    title: "Portal Field",
    ...
    patch(e4, { size: t4, length: r }) {
      return e4.replace(
        "float d1 = sdArc(st, center, 0.6, 0.02, 0.15);",
        `float d1 = sdArc(st, center, ${g(0.6 * r, 3)}, ${g(0.02 * t4, 4)}, 0.15);`
      ).replace(
        "float d2 = sdArc(st, center, 0.65, 0.06, 0.2);",
        `float d2 = sdArc(st, center, ${g(0.65 * r, 3)}, ${g(0.06 * t4, 4)}, 0.2);`
      );
    }
  },
  flowField: {
    ...
    patch(e4, { size: t4, length: r, density: o }) {
      return e4.replace(/<script defer src="https:\/\/static\.cloudflareinsights\.com\/beacon\.min\.js[^>]*><\/script>/, "").replace("const PARTICLE_COUNT = 2500;", `const PARTICLE_COUNT = ${s(2500, o, 300)};`).replace("let NOISE_SCALE = 0.0025;", `let NOISE_SCALE = ${Number((25e-4 / r).toFixed(6))};`).replace("time += 0.0008;", "time += 0.0008 * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||0);").replace(
        "let vx = Math.cos(angle) * p.speed * SPEED;",
      ...
      ).replace("ctx.lineWidth = p.size;", `ctx.lineWidth = p.size * ${Number(t4.toFixed(3))};`);
    }
  },
  amberHalftone: {
    ...
    source: n6,
    supportsMode: true,
    background: (e4) => e4 === "light" ? d : "#0A0A0A",
    targets: [{ selector: "#webgl-halftone", role: "background" }],
    patch(e4, { size: t4, length: r, density: o, mode: i }) {
      const a = Number((0.085 / Math.max(0.25, o)).toFixed(4)), n13 = Math.max(12, Math.ceil(2.8 / a)), u = Number((9 * t4).toFixed(2)), f = Number((6 * r).toFixed(2));
      let h = e4.replace("const gridSize = 20;", `const gridSize = ${n13};`).replace("positions.push(x * 0.15, y * 0.15, 0);", `positions.push(x * ${a}, y * ${a}, 0);`).replace(
        "float animatedScale = scale * (sin(dist * 6.0 - time * 2.5) * 0.5 + 0.5);",
  ...
  diagnosticsLayers: {
    ...
    source: t,
    supportsMode: true,
    background: (e4) => e4 === "light" ? d : "#020804",
  ...
  signalParticles: {
    ...
    background: (e4) => e4 === "light" ? d : "#0a0a0a",
    targets: [{ selector: "#particle-canvas", role: "background" }],
    patch(e4, { size: t4, length: r, mode: o }) {
      let i = e4.replace("const spacing = 16;", `const spacing = ${Math.max(6, Math.round(16 / Math.max(0.35, r)))};`).replace("const dotRadius = 1.5;", `const dotRadius = ${Number((1.5 * t4).toFixed(2))};`).replace("time += 0.02;", "time += 0.02 * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||1);");
  ...
  skeuomorphicToggle: {
    ...
    supportsMode: true,
    defaultMode: "auto",
    background: (e4) => e4 === "light" ? "#f8fafc" : "#0b1220",
...
`,
  ...
  gatewayFlow: {
    ...
    source: e3,
    supportsMode: true,
    background: (e4) => e4 === "light" ? d : "#000000",
    targets: [{ selector: "#flow-canvas", role: "background" }],
    patch(e4, { size: t4, density: r, mode: o }) {
      let i = e4.replace("const numPaths = 80;", `const numPaths = ${s(80, r, 12)};`).replace("p.t += p.speed;", "p.t += p.speed * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||1);").replace("ctx.lineWidth = 1.2;", `ctx.lineWidth = ${Number((1.2 * t4).toFixed(2))};`);
  ...
  connectivityGraph: {
    ...
    supportsMode: true,
    defaultMode: "light",
    background: (e4) => e4 === "light" ? "#c4d9ef" : "#0a1220",
    targets: [{ selector: "#networkCanvas", role: "background" }],
    patch(e4, { size: t4, length: r, density: o, mode: i }) {
      let a = e4.replace(
        "const particleCount = window.innerWidth < 768 ? 150 : 400;",
        `const particleCount = window.innerWidth < 768 ? ${s(150, o, 30)} : ${s(400, o, 60)};`
      ).replace("this.maxLength = 20 + Math.random() * 180;", `this.maxLength = (20 + Math.random() * 180) * ${r};`).replace("this.distance += this.speed;", "this.distance += this.speed * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||1);").replace("ctx.lineWidth = 0.5 + (distRatio * 2);", `ctx.lineWidth = (0.5 + (distRatio * 2)) * ${t4};`);
  ...
  interfaceLines: {
    ...
    source: n9,
    supportsMode: true,
    background: (e4) => e4 === "light" ? d : "#050505",
    ...
    patch(e4, { size: t4, length: r, density: o, mode: i }) {
      ...
      ).replace("p.x += p.vx;", "p.x += p.vx * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||1);").replace("p.y += p.vy;", "p.y += p.vy * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||1);").replace("if (dist < 120)", `if (dist < ${a})`).replace("ctx.lineWidth = 1;", `ctx.lineWidth = ${Number((1 * t4).toFixed(2))};`);
      return i === "light" ? n13 = n13.replace(
        "ctx.strokeStyle = `rgba(255, 255, 255, ${0.28 + (1 - dist / 120) * 0.42})`;",
        `ctx.strokeStyle = \`rgba(26, 31, 42, \${0.28 + (1 - dist / ${a}) * 0.42})\`;`
      ).replace("ctx.fillStyle = 'rgba(255, 255, 255, 0.85)';", "ctx.fillStyle = 'rgba(26, 31, 42, 0.85)';") : n13 = n13.replace(
        "ctx.strokeStyle = `rgba(255, 255, 255, ${0.28 + (1 - dist / 120) * 0.42})`;",
...
`,
    patch(e4, { variant: t4, size: r, length: o, mode: i }) {
      const a = he(t4), n13 = {
  ...
  defenseLines: {
    ...
    source: n10,
    supportsMode: true,
    background: (e4) => e4 === "light" ? "#f4ecec" : "#120303",
    targets: [{ selector: "#bg-canvas", role: "background" }],
    patch(e4, { size: t4, length: r, density: o, mode: i }) {
      let a = e4.replace(
        "const particleCount = window.innerWidth < 768 ? 40 : 100;",
      ...
      ).replace("ctx.lineWidth = 0.5;", `ctx.lineWidth = ${Number((0.5 * t4).toFixed(2))};`);
  ...
  overrideGrid: {
    ...
    patch(e4, { size: t4, gap: r, mode: o }) {
      const i = Math.max(8, Math.round(t4)), a = Math.max(0, Math.round(r));
      let n13 = e4.replace("const blockSize = 48;", `const blockSize = ${i};`).replace("const blockGap = 2;", `const blockGap = ${a};`).replace("time += 0.04;", "time += 0.04 * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||1);");
      return o === "light" && (n13 = n13.replace(
        "ctx.fillStyle = `rgba(249, 115, 22, ${alpha})`;",
  ...
  topoField: {
    ...
    patch(e4, { length: t4, density: r, mode: o }) {
      let i = e4.replace("float noiseScale = 1.4;", `float noiseScale = ${g(1.4 * t4, 3)};`).replace("float numBands = 10.0;", `float numBands = ${g(10 * r, 2)};`);
...
function xe(e4, t4) {
  const r = t4.mode, o = z(e4.background, r), i = JSON.stringify(e4.targets).replace(/</g, "\\u003c"), a = JSON.stringify({
    mode: r,
    speed: t4.speed,
    size: t4.size,
    gap: t4.gap,
    length: t4.length,
    density: t4.density,
    strokeWidth: t4.strokeWidth,
    opacity: t4.opacity
  }).replace(/</g, "\\u003c"), n13 = e4.patch ? e4.patch(e4.source, {
    variant: t4.variant,
    size: t4.size,
    gap: t4.gap,
    length: t4.length,
    ...
    strokeWidth: t4.strokeWidth,
    mode: r
  }) : e4.source, u = `<style data-threeui-focus>
...
<\/script>`;
  return n13.replace(/<head([^>]*)>/i, `<head$1>${f}${u}`).replace(/<\/body>/i, `${h}</body>`);
}
function G({
  definition: e4,
  variant: t4 = "cube",
  ...
  const N = (0, import_react.useRef)(null), v = r ?? e4.defaultMode ?? p.mode, Y = we(v === "auto"), w = v === "auto" ? Y : fe(v, p.mode), U = z(e4.background, w), k = m(o, 0, 3), x = m(i, 0.05, 200), S = m(a, 0, 64), b = m(n13, 0.35, 2.5), y = m(u, 0.25, 2.5), _ = m(f, 0.25, 8), L = m(h, 0.05, 1), M = m(B, -180, 180), T = m(I, 0, 2), R = m(H, 0.35, 1.65), A = (0, import_react.useMemo)(
    () => xe(e4, {
      variant: t4,
      mode: w,
      speed: p.speed,
  ...
  (0, import_react.useEffect)(() => {
    var _a;
    const E = (_a = N.current) == null ? void 0 : _a.contentWindow;
    E && E.postMessage(
      {
...
function c(e4) {
  return function(r) {
    return (0, import_jsx_runtime.jsx)(G, { ...r, definition: e4 });
  };
}
var Ge = c(l.constellationField);
var Be = c(l.particleDrift);
var Ie = c(l.particleNetwork);
var He = c(l.fluxVortex);
var Ve = c(l.portalField);
var qe = c(l.flowField);
var Ye = c(l.amberHalftone);
var W = {
  layers: l.diagnosticsLayers,
  nodes: l.diagnosticsNodes,
  flow: l.diagnosticsFlow
};
var je = c(l.signalParticles);
var Je = c(l.skeuomorphicToggle);
var Xe = c(l.matrixField);
var Ke = c(l.gatewayFlow);
var Qe = c(l.connectivityGraph);
var Ze = c(l.interfaceLines);
var et = c(l.wireframeForms);
var tt = c(l.defenseLines);
var rt = c(l.overrideGrid);
var ot = c(l.topoField);
...
//# sourceMappingURL=chunk-4OHHZ6YO.js.map
